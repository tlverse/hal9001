...
#' @param lambda_min_ratio the ratio of the largest to smallest lambda values lambda_min=lambda_max*lambda_min_ration
...
#' custom lasso implementation for indicators
#' @param x the covariate matrix
#' @param y the outcome vector
#' @param nlambda number of lambdas to fit. See \code{\link{lambda_seq}}
#' @param lambda_min_ratio ratio of largest to smallest lambda to fit. See \code{\link{lambda_seq}}
