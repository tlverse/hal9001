...
#' which to discard) based on the proportion of 1's (observations, i.e., "mass")
#' included in a given basis function.
#'
#' @param x_basis A matrix of basis functions with all redundant basis functions
#'  already removed.
...
#'  HAL algorithm.
#'
#' @return A binary \code{numeric} vector indicating which columns of the matrix
#'  of basis functions to keep (given a 1) and which to discard (given a 0).
#'
